 ...
 */
export function convertCharToInt(char: string, limit: number = 256): number {
 ...
 */
export function getImageSize(textLength: number, aspectRatio: [number, number] = [1, 1]): [number, number] {
